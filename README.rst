...
Take a look at older `releases <https://github.com/bechtoldt/saltstack-amavis-formula/releases>`_ to get a version that isn't using the formhelper
yet (if any).
...
But it’s better to `file an issue <https://github.com/bechtoldt/saltstack-amavis-formula/issues/new>`_ with your idea first.
